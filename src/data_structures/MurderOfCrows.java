...
public class MurderOfCrows {
	...
	private void findTheDiamond() {
		...
		for (int i = 0; i < theMurder.size(); i++) {
			...
			if (stomach.contains("diamond")) {
				name = theMurder.get(i).getName();
				i = theMurder.size();
			} else {
				innocentCrows++;
			}
		...
		System.out.println("The crow that had eaten the diamond was named " + name + ".");
		System.out.println("A total of " + innocentCrows + " crows had to die before the diamond was found.");
